...
6. Open any rest client(e.g PostMan) and submit a POST request as below with this 
	URL http://10.59.1.210:8080/RealTimeAnalytics/send
	Request JSON in the body of request: { "name": "Data4" }
	
7. In a new tab, run this URL: http://10.59.1.210:8080/RealTimeAnalytics/dashboard/all
...
c. Now when you try accessing the URL http://10.59.1.210:8080/RealTimeAnalytics/dashboard/all, you get live data form mongoDB 
